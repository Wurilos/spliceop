...
export function InternetForm({ open, onOpenChange, bill }: InternetFormProps) {
  ...
  const onSubmit = (values: FormValues) => {
    ...
    if (bill) {
      updateInternetBill({ id: bill.id, ...data });
    } else {
      createInternetBill(data);
    }
    onOpenChange(false);
  };
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>
            {bill ? 'Editar Conta de Internet' : 'Nova Conta de Internet'}
          </DialogTitle>
        </DialogHeader>
